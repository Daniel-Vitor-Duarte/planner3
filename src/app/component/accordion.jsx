...
const AccordionItem = ({ title, content }) => {
  ...
  return (
    <div className="accordion-item text-[1.25rem] w-full bg-[#E7E7E7] min-h-[2.75rem] rounded-[0.5rem] mt-2 pl-4 pt-2 cursor-pointer">
      <div
        className="accordion-header flex gap-2 items-center "
      ...
      >
        ...
        <h2 className="font-semibold text-[1.25rem] text-[#545353] leading-[1.75rem] sm:tracking-tight sm:text-[1rem]">
          {title}
        </h2>
      </div>
      {isOpen && (
        <div className="accordion-content max-w-[45rem] sm:max-w-[16.125rem] mx-auto sm:text-[1rem] mt-[.81rem] whitespace-pre-line pb-4">
          {content}
        </div>
      )}
    </div>
...
const accordionItems = [
  ...
  {
    title: "Estudo de Glória Mark (UC Irvine)",
    content:
  ...
  {
    title: "Trabalho Focado de Cal Newport",
    content:
