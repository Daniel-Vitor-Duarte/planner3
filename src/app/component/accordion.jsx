    ...
    <div>
      <Accordion  className='shadow-none text-[1.25rem] max-w-[52rem] w-full bg-[#E7E7E7] rounded-[0.5rem]'>
        ...
        >
          <div className='flex gap-2 items-center'>
            ...
            <Typography  className='font-semibold text-[1.25rem] text-[#545353] leading-[1.75rem] sm:tracking-tight sm:text-[1rem]'>Lei de Parkinson e Foco</Typography>
          </div>
        </AccordionSummary>
        <AccordionDetails>
      ...
      <Accordion  className='shadow-none text-[1.25rem] max-w-[52rem] w-full bg-[#E7E7E7] rounded-[0.5rem]'>
        ...
        >
          <div className='flex gap-2 sm:max-w-[16.6875rem] sm:w-full  items-center'>
            <div className='w-[0.125rem] h-[1.4375rem] bg-[#C6C6C6] '></div>
            <Typography  className='font-semibold text-[1.25rem] text-[#545353] leading-[1.75rem] sm:tracking-tight sm:text-[1rem]'>Estudo de Glória Mark (UC Irvine)</Typography>
          </div>
        </AccordionSummary>
        <AccordionDetails>
          <Typography className='max-w-[45rem] sm:max-w-[16.125rem] mx-auto sm:text-[1rem]'>
      ...
      <Accordion  className='shadow-none text-[1.25rem] max-w-[52rem] w-full bg-[#E7E7E7] rounded-[0.5rem]'>
        ...
        >
          <div className='flex gap-2 items-center'>
            <div className='w-[0.125rem] h-[1.4375rem] bg-[#C6C6C6] '></div>
            <Typography  className='font-semibold text-[1.25rem]  text-[#545353] leading-[1.75rem] sm:tracking-tight sm:text-[1rem]'>Trabalho Focado de Cal Newport</Typography>
          </div>
        </AccordionSummary>
        <AccordionDetails>
      ...
      <Accordion  className='shadow-none text-[1.25rem] max-w-[52rem] w-full bg-[#E7E7E7] rounded-[0.5rem]'>
        ...
        >
          <div className='flex gap-2 items-center'>
            <div className='w-[0.125rem] h-[1.4375rem] bg-[#C6C6C6] '></div>
            <Typography  className='font-semibold text-[1.25rem] text-[#545353] leading-[1.75rem] sm:tracking-tight sm:text-[1rem]'>Teoria do Flow</Typography>
          </div>
        </AccordionSummary>
        <AccordionDetails>
          <Typography className='max-w-[45rem] sm:max-w-[16.125rem] mx-auto sm:text-[1rem]'>
      ...
      <Accordion  className='shadow-none text-[1.25rem] max-w-[52rem] w-full bg-[#E7E7E7] rounded-[0.5rem]'>
        ...
        >
          <div className='flex gap-2 items-center'>
            <div className='w-[0.125rem] h-[1.4375rem] bg-[#C6C6C6] '></div>
            <Typography  className='font-semibold text-[1.25rem] text-[#545353] leading-[1.75rem] sm:tracking-tight sm:text-[1rem]'>A metodologia GTD</Typography>
          </div>
        </AccordionSummary>
        <AccordionDetails>
          <Typography className='max-w-[45rem] sm:max-w-[16.125rem] mx-auto sm:text-[1rem]'>
